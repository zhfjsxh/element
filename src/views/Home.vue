<template>
  ...
  <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
    <el-menu :default-openeds="['1', '3']" router>
      <el-submenu index="1">
        <template slot="title"><i class="el-icon-message"></i>张海峰</template>
<el-menu-item-group>
...
<el-submenu index="2">
    <template slot="title"><i class="el-icon-menu"></i>张雄</template>
    <el-menu-item-group>
        <!-- <template slot="title">分组一</template> -->
        <el-menu-item index="/user">用户列表</el-menu-item>
        <el-menu-item index="/logbook">文章列表</el-menu-item>
    </el-menu-item-group>
